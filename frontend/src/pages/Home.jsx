    ...
    <>
      <div className="App min-h-screen overflow-x-hidden">
        ...
        <div className='space-y-56'>
            ...
            <section className="relative overflow-visible card py-52 px-7 lg:px-20">
                <div className="flex flex-col items-center relative">
                    <img src="/img/Home/accounts _ contract, document, profile, signature, policy, man, paper, page.webp" alt="" className="absolute w-[20vh] bottom-[40vh] left-0 lg:w-[30vh] lg:top-[10vh] lg:left-[10vh] z-10"/>
                    <img src="/img/Home/business _ deal, contract, handshake, man, woman, agreement.webp" alt="" className="absolute w-[20vh] lg:w-[30vh] top-[40vh] right-0 lg:-top-[20vh] lg:right-[10vh] z-10"/>
