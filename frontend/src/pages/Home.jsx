    ...
    <>
      <div className="App min-h-screen">
        ...
        <div className='space-y-56'>
            ...
            <FadeInSection>
                <section className='grid grid-rows-1 md:grid-rows-2 px-20 gap-y-20'>
                    <div className='grid grid-cols-2 px-0 md:px-10 gap-x-20'>
            ...
            <section className="relative overflow-visible card py-52 px-20">
                <div className="flex flex-col items-center relative">
                    <img src="/img/Home/accounts _ contract, document, profile, signature, policy, man, paper, page.webp" alt="" className="w-[30vh] absolute top-[10vh] left-[10vh] z-10"/>
                    <img src="/img/Home/business _ deal, contract, handshake, man, woman, agreement.webp" alt="" className="w-[30vh] absolute bottom-[10vh] right-[10vh] z-10"/>
                    <div className="w-1/2 text-center text text-2xl flex flex-col gap-y-5 items-center z-20 relative">
